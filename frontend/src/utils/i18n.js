const translations = {
  en: {
    ...
    eligibleSummary: (e, t) => `You may qualify for ${e} out of ${t} programs, based on this screening.`,
    ...
    qualified: 'May Qualify',
    conditional: 'Conditional',
    notEligible: 'May Not Qualify Yet',
  ...
  fil: {
    ...
    eligibleSummary: (e, t) => `Maaaring kwalipikado ka sa ${e} sa ${t} na programa, batay sa paunang pagsusuri.`,
    ...
    qualified: 'Maaaring Kwalipikado',
    conditional: 'May Kondisyon',
    notEligible: 'Maaaring Hindi Kwalipikado',
