...
(DeepSeek and OpenAI also work since the code uses the standard `openai` Python client — just swap `AI_BASE_URL`/`AI_MODEL`. DeepSeek and OpenAI require prepaid credit; Groq doesn't.)
